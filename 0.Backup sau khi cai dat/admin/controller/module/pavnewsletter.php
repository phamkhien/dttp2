...
class ControllerModulePavnewsletter extends Controller {
	...
	public function _getLanguage() {
		...
		$this->mdata['action'] = $this->url->link('module/pavnewsletter', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('module/pavnewsletter', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$template = 'module/pavnewsletter/panel.tpl';
	...
	public function subsribes(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->response->redirect($this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$this->mdata['action'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->mdata['sort_name'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$this->mdata['sort_email'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . '&sort=email' . $url, 'SSL');
		$this->mdata['sort_subscribe'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . '&sort=s.action' . $url, 'SSL');
		$this->mdata['sort_customer_group_id'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . '&sort=customer_group_id' . $url, 'SSL');
		$this->mdata['sort_store_id'] = $this->url->link('module/pavnewsletter/subsribes', 'token=' . $this->session->data['token'] . '&sort=s.store_id' . $url, 'SSL');
		...
		$template = 'module/pavnewsletter/subscribes.tpl';
    ...
    $this->load->model("pavnewsletter/draft");
		...
		$this->mdata['cancel'] = $this->url->link('module/pavnewsletter/templates', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->redirect($this->url->link('module/pavnewsletter/draft', 'token=' . $this->session->data['token'], 'SSL'));
      ...
      $this->mdata['detail'] = $this->url->link('module/pavnewsletter/create_newsletter', 'token=' . $this->session->data['token'] . $url . '&id=', 'SSL');
      $this->mdata['action'] = $this->url->link('module/pavnewsletter/draft', 'token=' . $this->session->data['token'], 'SSL');
      ...
      $template = 'module/pavnewsletter/draft_newsletter.tpl';
	...
	public function get_template(){
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$this->response->redirect($this->url->link('module/pavnewsletter/create_newsletter', 'token=' . $this->session->data['token'], 'SSL'));
		}
	}
	...
	public function create_newsletter(){
		...
		$this->mdata['action'] = $this->url->link('module/pavnewsletter/create_newsletter', 'token=' . $this->session->data['token'], 'SSL');

    	$this->mdata['save'] = $this->url->link('module/pavnewsletter/save_draft', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->mdata['customer_groups'] = $this->model_sale_customer_group->getCustomerGroups(0);
    ...
    $this->mdata['affiliates'] = array();
      ...
      if (isset($this->request->post['affiliate']) && is_array($this->request->post['affiliate'])) {
		...
		$template = 'module/pavnewsletter/form_newsletter.tpl';
		$this->_render($template);
	}
	...
	public function templates(){
		...
		$this->mdata['insert_link'] = $this->url->link('module/pavnewsletter/template', 'token=' . $this->session->data['token'], 'SSL');
		$this->mdata['action'] = $this->url->link('module/pavnewsletter/templates', 'token=' . $this->session->data['token'], 'SSL');
		
		$template = 'module/pavnewsletter/templates.tpl';
		$this->_render($template);
	}
	...
	public function template(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			if($action == "get_template"){
				...
				$this->response->redirect($this->url->link('module/pavnewsletter/templates', 'token=' . $this->session->data['token'], 'SSL'));
			}
		...
		$this->mdata['action'] = $this->url->link('module/pavnewsletter/template', 'token=' . $this->session->data['token'], 'SSL');
		

		$template = 'module/pavnewsletter/form_template.tpl';
		$this->_render($template);
	}
	public function modules(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				...
				$this->response->redirect( $this->url->link('module/pavnewsletter/modules', 'token=' . $this->session->data['token'], 'SSL') );
			} else {
				$this->model_extension_module->editModule($this->request->get['module_id'], $this->request->post);
				$this->response->redirect( $this->url->link('module/pavnewsletter/modules', 'token=' . $this->session->data['token'].'&module_id='.$this->request->get['module_id'], 'SSL') );
			}
			$this->session->data['success'] = $this->language->get('text_success');
		}
		...
		// action
		$this->mdata['delete'] = $this->url->link('module/pavnewsletter/ndelete', 'token=' . $this->session->data['token'].$url, 'SSL');
		$this->mdata['action'] = $this->url->link('module/pavnewsletter/modules', 'token=' . $this->session->data['token'].$url, 'SSL');
		...
		$template = 'module/pavnewsletter/frontend_modules.tpl';
		$this->_render($template);
	}
	...
	public function module($extension, $module_id){
		...
		foreach ($modules as $module) {
			$module_data[] = array(
				...
				'name'      => $module['name'],
				'edit'      => $this->url->link('module/pavnewsletter/modules', 'token=' . $this->session->data['token'] . $module_id.'=' . $module['module_id'], 'SSL'),
			);
		}
		$ex[] = array(
			'name'      => $this->language->get("create_module"),
			'module'    => $module_data,
			'edit'      => $this->url->link('module/pavnewsletter/modules', 'token=' . $this->session->data['token'], 'SSL')
		);
		return $ex;
	}
	...
	public function config(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('module/pavnewsletter/config', 'token=' . $this->session->data['token'], 'SSL'));
		}
    	...
    	$this->mdata['action'] = $this->url->link('module/pavnewsletter/config', 'token=' . $this->session->data['token'], 'SSL');
		...
		// Render
		$template = 'module/pavnewsletter/config.tpl';
		$this->_render($template);
	}
