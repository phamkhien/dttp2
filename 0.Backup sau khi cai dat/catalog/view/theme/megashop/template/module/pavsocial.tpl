    ...
    <ul class="list-socials">
		...
		<li class="youtube">			
			...
			<div class="box-content">		
				<object width="<?php echo $video_width; ?>" height="<?php echo $video_height; ?>" data="https://www.youtube.com/v/<?php echo trim($video_ids); ?>?version=3&amp;autoplay=0" type="application/x-shockwave-flash"> </object>
			</div>
		</li>
		<?php } ?>
