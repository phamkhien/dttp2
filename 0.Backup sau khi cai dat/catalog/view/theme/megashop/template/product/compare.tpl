   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="wrapper clearfix"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-outline btn-block" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
            <a href="<?php echo $product['remove']; ?>" class="btn btn-inverse btn-block"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      <?php } else { ?>
