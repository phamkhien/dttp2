    ...
    public function genTreeAccordion( $parent, $level , $class="", $category_id){
        if( $this->hasChild($parent) ){
            ...
            foreach( $data as $menu ){
                ...
                $output .= '<a class="'.$active.'" href="'.$this->url->link('pavblog/category',"id=".$menu['category_id']).'" >';
        ...
        if( $this->hasChild($parent) ){
            ...
            foreach( $data as $menu ){
                ...
                if( $this->hasChild($menu['category_id']) ){
                    ...
                    $output .= '<a class="dropdown-toggle" data-toggle="dropdown" href="'.$this->url->link('pavblog/category',"id=".$menu['category_id']).'" >';
                    $output .= '<span class="blog-name">'.$menu['title'].'</span>';
                    $output .= '<b class="caret"></b></a>';
                } else {
                    $output .= '<li>';
                    $output .= '<a href="'.$this->url->link('pavblog/category',"id=".$menu['category_id']).'" >'.$menu['title'].'</a>';
                }
