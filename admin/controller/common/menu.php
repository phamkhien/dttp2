...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		// cuongnd them moi
		$data['module_pavautosearch'] = $this->url->link('module/pavautosearch', 'token=' . $this->session->data['token'], 'SSL');
		$data['module_pavbannerbuilder'] = $this->url->link('module/pavbannerbuilder', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavblog'] = $this->url->link('module/pavblog', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavcarousel'] = $this->url->link('module/pavcarousel', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavcategorytabs'] = $this->url->link('module/pavcategorytabs', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavhomebuilder'] = $this->url->link('module/pavhomebuilder', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavmap'] = $this->url->link('module/pavmap', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavnewsletter'] = $this->url->link('module/pavnewsletter', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavproducttabs'] = $this->url->link('module/pavproducttabs', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavreassurance'] = $this->url->link('module/pavreassurance', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavsliderlayer'] = $this->url->link('module/pavsliderlayer', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavsocial'] = $this->url->link('module/pavsocial', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavverticalcategorytabs'] = $this->url->link('module/pavverticalcategorytabs', 'token=' . $this->session->data['token'], 'SSL');
		$data['pav_module_pavverticalmenu'] = $this->url->link('module/pavverticalmenu', 'token=' . $this->session->data['token'], 'SSL');
