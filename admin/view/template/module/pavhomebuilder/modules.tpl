									    	...
									    	<?php $i =0; foreach( $widgets as $type => $widget ){ ?>
					       							 	...
					       							 	<?php 
																...
																<div class="mod-item wpo-ijwidget wpo-wg-button" data-group="'.$widget->group.'" data-type="'.$type.'"  data-widget="'.$type.'"  >
																	...
																	<div title="Edit"  data-placement="top" data-toggle="tooltip" class="wpo-wedit ptstooltip"></div>
																	<div title="Copy" data-placement="top" data-toggle="tooltip" class="wpo-wcopy ptstooltip"></div>	 
																	<div title="Delete" data-placement="top" data-toggle="tooltip" class="wpo-wdelete ptstooltip"></div>	 
																</div>
...
$(".layout-builder-wrapper").each( function(){
	var config = { 
      	  urlwidgets:'',
          urlwidget:'index.php?route=module/pavhomebuilder/widget&token=<?php echo $token; ?>',
          urlwidgetdata:'',
