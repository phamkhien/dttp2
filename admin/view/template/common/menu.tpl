<ul id="menu">
  ...
  <li><a class="parent">
    ...
    <ul>
      <li><a href="<?php echo $pavo_link; ?>">Cài đặt chung</a></li>
      
      <li><a href="<?php echo $megamenu_link; ?>">Menu ngang</a></li>
      
      <li><a href="<?php echo $pav_module_pavverticalmenu; ?>">Menu dọc</a></li>
	  
      <li><a href="<?php echo $pav_module_pavblog; ?>">Quản lý tin tức</a></li>

      <li><a href="<?php echo $module_pavautosearch; ?>">Tìm kiếm</a></li>
      
      <li><a href="<?php echo $module_pavbannerbuilder; ?>">Banners Builder</a></li>
      
      <li><a href="<?php echo $pav_module_pavcarousel; ?>">Carousel</a></li>

      <li><a href="<?php echo $pav_module_pavcategorytabs; ?>">Tabs danh mục</a></li>
      
      <li><a href="<?php echo $pav_module_pavhomebuilder; ?>">Home Page Builder</a></li>
      
      <li><a href="<?php echo $pav_module_pavmap; ?>">Bản đồ</a></li>
      
      <li><a href="<?php echo $pav_module_pavnewsletter; ?>">Bản tin</a></li>
      
      <li><a href="<?php echo $pav_module_pavproducttabs; ?>">Tab Sản phẩm</a></li>
      
      <li><a href="<?php echo $pav_module_pavreassurance; ?>">Reassurance</a></li>
      
      <li><a href="<?php echo $pav_module_pavsliderlayer; ?>">Layers Sliders</a></li>
      
      <li><a href="<?php echo $pav_module_pavsocial; ?>">Mạng xã hội</a></li>
      
      <li><a href="<?php echo $pav_module_pavverticalcategorytabs; ?>">Vertical Category Tabs</a></li>
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
    <ul>
      <li><a href="<?php echo $export_import; ?>">Export / Import</a></li>
