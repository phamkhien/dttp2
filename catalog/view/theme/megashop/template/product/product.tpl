...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="contents" class="wrappers clearfix"><?php echo $content_top; ?>
        ...
        ?>
        <div class="box products-related"> <?php require( PAVO_THEME_DIR."/template/product/product_related.tpl" );  ?> </div>
