...
<div class="box pav-verticalcategorytabs clearfix <?php echo $prefix_class; ?>">
    ...
    <div class="box-wapper <?php echo $prefix_class ?> clearfix">
        <div class="tab-heading box-heading clearfix nopadding k-nomargin">

            <div class="nav-header navbar-brand">
                <?php echo $category_name;
                if( !empty($module_description) ) { } ?>
            </div>
            <ul class="nav nav-pills k-right nopadding" id="pav-categorytabs41">
                <?php foreach ($tabs as $key=>$tab): ?>
                <li class="k-left"><a class="k-color-white" href="#tab<?php echo $id."-cat".$key;?>" role="tab" data-toggle="tab"><?php echo $tab['name']; ?></a></li>
                <?php endforeach; ?>
